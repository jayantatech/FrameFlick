...
const HeroFilmInfo = ({ data, imageAdd }) => {
  return (
    <div className=" w-full md:h-[280px] max-md:hidden absolute bottom-0 flex items-center justify-center my-8">
      <div className=" h-full lg:w-[70%] min-md:w-[70%] max-lg:w-[90%] max-md:translate-y-24 max-lg:-translate-y-48 bg-[#747272] backdrop-filter backdrop-blur-sm bg-opacity-60 md:px-4 z-10 grid grid-flow-col max-md:grid-flow-row md:grid-cols-5 max-md:grid-rows-4 gap-10 max-lg:gap-24 rounded-lg">
