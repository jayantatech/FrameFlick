  ...
  return (
    <ContentWrapper>
      <div className=" relative top-0 left-0 w-full h-[590px] max-md:h-[670px] flex items-end justify-center py-4 z-40">
        <div className=" w-full min-h-[330px] max-lg:min-h-[270px] max-md:min-h-[470px] rounded-lg  bg-[#636262] backdrop-filter backdrop-blur-sm bg-opacity-60 p-4 max-lg:px-2 flex flex-row gap-2 max-md:flex-col">
