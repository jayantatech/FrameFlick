...
const RattingBox = ({ data }) => {
  ...
  return (
    {averageVote && votePointer  <div className=" text-lg font-extrabold font-[Roboto] flex items-center justify-start gap-2 px-2 py-1 rounded-lg bg-white md:w-[150px]  max-md:w-[50%]">
    Rating:
